...
ArrayList<std::string> places = {"Amtrak Station", "Buena Vista Dr", "Cardella Rd. & 'M' Street (North)", "Cardella Rd. & 'M' Street (South)", "Compass Pointe Apts", 
...
ArrayList<std::string> geo_places = {"355 West 24th Street, Merced, CA", "1835, Buena Vista Drive, Merced, Merced County, California, 95348, United States", "595, Glendon Court, Bellevue Ranch, Bellview Ranch, Merced, Merced County, California, 95348, United States", "4298, Lasalle Drive, The Meadows At Bellevue Ranch West, Bellevue Ranch, Bellview Ranch, Merced, Merced County, California, 95348, United States", "1220 Daybreak Dr, Merced, CA 95348", "19, El Portal Drive, Merced, Merced County, California, 95340, United States",
                ...
                "621 M St, Merced, CA 95348", "415, West 18th Street, Merced, Merced County, California, 95340, United States", "586 Barclay Way, Merced, CA 95348", "597, Collins Drive, Merced, Merced County, California, 95348, United States", "1223, Devonwood Drive, Merced, Merced County, California, 95348, United States", "614, Stanford Court, Merced, Merced County, California, 95348, United States", "Target, 3280, R Street, Merced, Merced County, California, 95348, United States",
                ...
                "315 Mercy Avenue, Merced, CA, USA", "3601 G Street, Merced, CA", "UC Merced Downtown Campus Center", "3607, East Yosemite Avenue, Merced, Merced County, California, 95340, United States", "2897 Bellevue Rd, Merced, CA 95340",
                "3300, M Street, Merced, Merced County, California, 95348, United States", "Merced County Food Bank, 2000, West Olive Avenue, Merced, Merced County, California, 95348, United States", "Doctors Carreon Adrian Md, 410, East Yosemite Avenue, Merced, Merced County, California, 95340, United States", "Yosemite North Shopping Center, G Street, Merced, Merced County, California, 98348, United States"};
...
HashTable<std::string> bobcat_table("Bobcat Express", bobcat_express_stops_keys);
...
ArrayList<std::list<std::string>> C1_stops_values = {{"6:20", "7:31", "8:57", "10:08", "11:34", "12:45", "2:16", "3:27", "4:53", "6:04", "7:15", "8:41", "9:52", "REQ:"}, 
...
HashTable<std::string> C1_table("C1", C1_stops_keys);
...
ArrayList<std::list<std::string>> C2_stops_values = {{"6:20", "7:18", "8:31", "9:29", "10:42", "11:40", "12:53", "1:51", "2:52", "3:50", "5:03", "6:01", "7:14", "8:12", "9:25", "REQ:"}, 
...
HashTable<std::string> C2_table("C2", C2_stops_keys);
...
ArrayList<std::list<std::string>> E1_stops_values = {{"8:30", "9:42", "10:39", "11:51", "12:48", "2:00", "2:57", "3:54", "4:54", "6:06", "7:03", "8:00", "9:12", "10:09", "11:06"}, 
...
HashTable<std::string> E1_table("E1", E1_stops_keys);
...
ArrayList<std::list<std::string>> E2_stops_values = {{"8:30", "9:42", "10:39", "11:51", "12:48", "2:00", "2:57", "3:54", "4:54", "6:06", "7:03", "8:00", "9:12", "10:09", "11:06"}, 
                   {"8:39", "9:51", "10:48", "12:00", "12:57", "2:09", "3:06", "4:03", "5:03", "6:15", "7:12", "8:09", "9:21", "10:18"}, 
                   {"8:46", "9:58", "10:55", "12:07", "1:04", "2:16", "3:13", "4:10", "5:10", "6:22", "7:19", "8:16", "9:28", "10:25"}, 
                   {"8:48", "10:00", "10:57", "12:09", "1:06", "2:18", "3:15", "4:15", "5:12", "6:24", "7:21", "8:18", "9:30", "10:27"}, 
                   {"9:01", "10:13", "11:10", "12:22", "1:19", "2:31", "3:28", "4:28", "5:25", "6:37", "7:34", "8:31", "9:43", "10:40"}, 
...
HashTable<std::string> E2_table("E2", E2_stops_keys);
...
ArrayList<std::list<std::string>> Fastcat_stops_values = {{"8:30", "9:34", "10:53", "11:57", "1:01", "2:20", "3:24", "4:31", "5:50", "6:54", "8:13", "9:17", "9:34", "10:53", "11:57", 
...
HashTable<std::string> Fastcat_table("Fastcat", Fastcat_stops_keys);
...
ArrayList<std::list<std::string>> Fastcat2_stops_values = {{"8:30", "9:34", "10:53", "11:57", "1:01", "2:20", "3:24", "4:31", "5:50", "6:54", "8:13", "9:17", "9:34", "10:53", "11:57", 
                          "12:61", "2:20", "3:24", "4:31", "5:50", "6:54", "8:13", "9:17", "9:14", "10:33", "11:37", "12:41", "1:45", "3:04", "4:08", "5:15", "6:34", "7:38", "8:57", "REQ"}, 
                          {"8:34", "9:38", "10:57", "12:01", "1:05", "2:24", "3:28", "4:35", "5:54", "6:58", "8:17", "9:21"}, 
                          {"8:37", "9:41", "11:00", "12:04", "1:08", "2:27", "3:31", "4:38", "5:57", "7:01", "8:20", "9:24"}, 
                          {"8:39", "9:43", "11:02", "12:06", "1:10", "2:29", "3:33", "4:40", "5:59", "7:03", "8:22", "9:26", 
...
HashTable<std::string> Fastcat2_table("Fastcat 2", Fastcat_stops_keys);
...
ArrayList<std::list<std::string>> G_line_stops_values = {{"6:30", "7:38", "9:01", "10:09", "11:17", "12:25", "1:48", "3:01", "4:09", "5:32", "6:40", "7:48", "9:11", "7:38", "9:01", "10:09", "11:17", "12:25", "1:48", "3:01", "4:09", "5:32", "6:40", "7:48", "9:11", "REQ:"}, 
...
HashTable<std::string> yosemite_express_table("Yosemite Express", yosemite_express_stops_keys);
