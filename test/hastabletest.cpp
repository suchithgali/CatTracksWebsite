...
int main(){
     // Example: ensure bobcat_express_stops_keys and bobcat_express_stops_values have data
   ...
   ArrayList<std::list<std::string>> bobcat_express_stops_values = {{"6:29", "7:09", "7:49", "8:44", "9:24", "10:04", "10:44", "12:09", "1:49", "3:17", "4:57", "6:22", "8:02"}, 
    ...
    HashTable<std::string> table(bobcat_express_stops_keys);
    table.appendHashes(bobcat_express_stops_keys, bobcat_express_stops_values);
